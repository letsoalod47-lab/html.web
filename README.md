...
**Maps Section:** Embedded Google Maps frames for the listed locations
...
### CSS Organization
- Shared stylesheet: `images/CSS/style.css`
...
- CSS is centralized in `images/CSS/style.css` and linked from every HTML page
